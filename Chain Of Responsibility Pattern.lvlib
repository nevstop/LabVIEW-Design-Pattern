...
<Library LVVersion="14008000">
	...
	<Item Name="Handler" Type="Folder">
		<Item Name="Level1Handler.lvclass" Type="LVClass" URL="../Handler/Level1Handler_class/Level1Handler.lvclass"/>
		<Item Name="Level2Handler.lvclass" Type="LVClass" URL="../Handler/Level2Handler_class/Level2Handler.lvclass"/>
		<Item Name="Level3Handler.lvclass" Type="LVClass" URL="../Handler/Level3Handler_class/Level3Handler.lvclass"/>
	</Item>
	<Item Name="Support" Type="Folder">
		<Item Name="HandlerCore.lvclass" Type="LVClass" URL="../HandlerCore_class/HandlerCore.lvclass"/>
	</Item>
	<Item Name="ErrorHandler(Handler).lvclass" Type="LVClass" URL="../ErrorHandler(Handler)_class/ErrorHandler(Handler).lvclass"/>
	<Item Name="GetChain.vi" Type="VI" URL="../GetChain.vi"/>
</Library>
